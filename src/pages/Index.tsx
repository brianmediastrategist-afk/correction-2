                ...
                <div className="relative w-[300px] sm:w-[340px] lg:w-[400px] aspect-[9/16] bg-white rounded-[2.5rem] overflow-hidden border border-secondary/10 hover:scale-[1.02] transition-all duration-500 group" style={{ boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 flex items-center justify-center gap-3">
                    <a
                      ...
                      className="w-12 h-12 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center hover:scale-125 transition-all duration-300 hover:shadow-lg group/icon opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0"
                      style={{ transitionDelay: '0ms' }}
                    >
                      <svg className="w-6 h-6 text-[#E4405F] group-hover/icon:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg className="w-6 h-6 text-[#000000] group-hover/icon:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg className="w-6 h-6 text-[#0A66C2] group-hover/icon:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg className="w-6 h-6 text-primary group-hover/icon:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
